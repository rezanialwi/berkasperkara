				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								<h1>
									<img class="nav-user-photo" src="assets/images/gallery/logo.png" width="50px" height="60px" />
									<br>
									<span class="white" id="id-text2">Aplikasi Peminjaman Arsip Berkas Perkara</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; Pengadilan Negeri Banjarmasin</h4>
							</div>
