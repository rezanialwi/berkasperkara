				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Hasil Pencarian Peminjaman</li>
						</ul><!-- /.breadcrumb -->
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-header">
                                           ...
                                           <a href="<?php echo site_url('admin') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
    <i class="ace-icon fa fa-home fa-sm text-white-50"></i>Kembali</a>
		  ...
		  <div class="nav-search" id="nav-search">
							<?php echo form_open('admin/search') ?>
								<span class="input-icon">
									<input type="text" placeholder="Cari..." class="nav-search-input" id="nav-search-input" name="keyword"  autocomplete="off" />
...
?>
			...
			<td>
                ...
                <div class="hidden-sm hidden-xs btn-group">
			     <?php echo anchor('admin/edit/'.$data->id_peminjaman,'<button class="btn btn-info" > 
                    <i class="ace-icon fa fa-pencil"></i>'); ?>
                 <?php echo anchor('admin/hapus/'.$data->id_peminjaman,'<button class="btn btn-danger">
                    <i class="fa fa-trash"></i>'); ?>
                    
                    <?php echo anchor('admin/tambah_tglkembali/'.$data->id_peminjaman,'<button class="btn btn-warning" >
					<i class="fa fa-plus"></i>'); ?>
					<?php echo anchor('admin/detail/'.$data->id_peminjaman,'<button class="btn btn-" >
