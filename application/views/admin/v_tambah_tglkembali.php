				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Edit Pengembalian Peminjaman</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-header">
							<h1>
								Tambah Data pengembalian Peminjaman
                       ...
                       <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="hidden" id="form-field-1" value="<?php echo $u->nama_peminjam ?>" class="col-xs-10 col-sm-5" name="nama_peminjam" />
										</div>
									</div>
							...
							<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" placeholder=" Berkas Yang Dipinjam Nomor" class="form-control" name="berkas_dipinjam" value="<?php echo $u->berkas_dipinjam ?>" readonly/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="hidden" id="form-field-1" class="col-xs-10 col-sm-5 " name="tgl_pinjam" value="<?php echo $u->tgl_pinjam ?>"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="hidden" id="form-field-1" class="col-xs-10 col-sm-5 " name="status" value="dikembalikan"/>
										</div>
									</div>
									<!-- <div class="form-group">
